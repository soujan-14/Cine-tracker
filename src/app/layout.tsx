...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/logo.png', width: 1254, height: 1254, type: 'image/png' }],
  },
  twitter: {
