...
function total(record: RecordItem) {
  return (
    (record.dailyCollection ?? 0) +
    (record.weekendCollection ?? 0)
  );
}
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-white/50">
                Publish and maintain your box-office collection updates.
              </p>
            </div>
          </div>
        ...
        >
          <div className="md:col-span-2">
            ...
            <p className="mt-1 text-sm text-white/45">
              Existing records for your movie/date/territory are updated instead of duplicated.
            </p>
          </div>
          ...
          <label>
            <span className="mb-2 block text-sm font-medium text-white/70">
              Movie title (new association only)
            </span>
          ...
          <label>
            ...
            <input
              ...
              placeholder="India / Karnataka / Worldwide"
              className="min-h-11 w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-white outline-none focus:border-[#E50914]/60"
            />
          </label>
        ...
        <section className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-white/45">
              Only records owned by your authenticated distributor account are shown.
            </p>
          </div>
              ...
              .map((record) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-white/75">
                    Daily:{' '}
                    {money(
                      record.dailyCollection,
                    )}{' '}
                    · Weekend:{' '}
                    {money(
                      record.weekendCollection,
                    )}
                  </p>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <Link
                      href={`/distributor/box-office/${record.id}/edit`}
                      className="inline-flex min-h-9 items-center gap-1 rounded-lg border border-white/10 px-3 text-xs font-semibold transition hover:bg-white/10"
                    >
        ...
        <section className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-white/45">
              Movie, date, daily, weekend, total, submitted by, and last updated.
            </p>
          </div>
