...
export default function DistributorPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    setMessage('Updating…');
    try {
      const response = await fetch('/api/admin/box-office', {
