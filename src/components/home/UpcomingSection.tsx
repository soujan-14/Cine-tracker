...
import { useUpcomingMovies } from '@/hooks/useTmdbMovies';
...
export function UpcomingSection() {
  const { data, isLoading, isError, error, refetch } = useUpcomingMovies();
  ...
  return (
    ...
    >
      <SectionHeader label="🎬 Coming Soon" href="/discover?sort_by=release_date.desc" />
